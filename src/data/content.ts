...
export const profileData: ProfileData = {
  ...
  about: [
    "Computer Engineer with hands-on experience in software development and autonomous drone technology.",
  ...
  socials: [
    ...
    {
      platform: "LinkedIn",
      url: "https://linkedin.com/in/ioritz-tubio",
      label: "LinkedIn"
    },
    {
      platform: "Email",
...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: "Completed a degree in Computer Engineering. Focused on software development, problem solving and collaborative engineering practices."
  },
  {
    type: "education",
...
export const projectsData: Project[] = [
  {
    ...
    description: "AI-powered free dental diagnosis tool. Users upload a photo and receive a preliminary oral health assessment generated by AI in minutes. I contributed across the product end-to-end as part of the engineering team at Skootik for the PKF Attest AI Department, funded by the EU, Spanish Government and Eusko Jaurlaritza.",
