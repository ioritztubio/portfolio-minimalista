        ...
        items: [
            {
                ...
                description: "AI-powered dental pre-diagnosis tool, designed primarily for mobile. Users upload a photo and receive a preliminary oral health assessment in minutes, generated by a custom AI pipeline. I contributed across the product end-to-end, working on both the frontend (Next.js + TypeScript) and backend (Django + Python) as part of the team. The app is live, used by real patients, and funded by the EU, the Spanish Government and the Basque Government (Eusko Jaurlaritza). Source code is private due to company policies — but you can try the live application.",
